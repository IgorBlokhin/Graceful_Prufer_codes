...
Parts of the graph-related code are based on the Diktyonphi module originally developed by Mgr. Jiří Fišer, Ph.D., a RNDr. Jiří Škvára, Ph.D., for educational purposes and have been adapted and extended for the needs of this project. Original version: https://github.com/Jiri-Fiser/DiktyonPhi/blob/master/diktyonphi.py
